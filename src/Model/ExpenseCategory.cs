...
namespace InvoiceNinjaSDK.Model
{
        ...
        public partial class ExpenseCategory :  IEquatable<ExpenseCategory>, IValidatableObject
    {
        ...
        public ExpenseCategory(string id = default(string), string name = default(string), string userId = default(string), bool? isDeleted = default(bool?), string updatedAt = default(string), string createdAt = default(string))
        {
            this.Id = id;
            this.Name = name;
            this.UserId = userId;
