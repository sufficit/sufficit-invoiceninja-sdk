...
namespace InvoiceNinjaSDK.Api
{
        ...
        public interface IPreviewApi : IApiAccessor
    {
        ...
        ApiResponse<Object> GetPreviewWithHttpInfo (string xApiSecret, string xRequestedWith);
        ...
        System.Threading.Tasks.Task GetPreviewAsync (string xApiSecret, string xRequestedWith);
        ...
        System.Threading.Tasks.Task<ApiResponse<Object>> GetPreviewAsyncWithHttpInfo (string xApiSecret, string xRequestedWith);
        ...
        public partial class PreviewApi : IPreviewApi
    {
        ...
        /// <returns></returns>
        public PreviewApi(InvoiceNinjaSDK.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Returns a pdf preview Returns a pdf preview.
        /// </summary>
        /// <exception cref="InvoiceNinjaSDK.ApiException">Thrown when fails to make API call</exception>
        /// <param name="xApiSecret">The API secret as defined by the .env variable API_SECRET</param>
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns></returns>
        public void GetPreview (string xApiSecret, string xRequestedWith)
        {
             GetPreviewWithHttpInfo(xApiSecret, xRequestedWith);
        }
        ...
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> GetPreviewWithHttpInfo (string xApiSecret, string xRequestedWith)
        {
            // verify the required parameter 'xApiSecret' is set
            if (xApiSecret == null)
                throw new ApiException(400, "Missing required parameter 'xApiSecret' when calling PreviewApi->GetPreview");
            // verify the required parameter 'xRequestedWith' is set
            if (xRequestedWith == null)
                throw new ApiException(400, "Missing required parameter 'xRequestedWith' when calling PreviewApi->GetPreview");

            var localVarPath = "/api/v1/preview";
            ...
            {
                Exception exception = ExceptionFactory("GetPreview", localVarResponse);
        ...
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task GetPreviewAsync (string xApiSecret, string xRequestedWith)
        {
             await GetPreviewAsyncWithHttpInfo(xApiSecret, xRequestedWith);
        ...
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> GetPreviewAsyncWithHttpInfo (string xApiSecret, string xRequestedWith)
        {
            // verify the required parameter 'xApiSecret' is set
            if (xApiSecret == null)
                throw new ApiException(400, "Missing required parameter 'xApiSecret' when calling PreviewApi->GetPreview");
