...
namespace InvoiceNinjaSDK.Api
{
        ...
        public interface ITemplatesApi : IApiAccessor
    {
        ...
        ApiResponse<Template> GetShowTemplateWithHttpInfo (Body5 body, string xApiSecret, string xRequestedWith);
        ...
        System.Threading.Tasks.Task<Template> GetShowTemplateAsync (Body5 body, string xApiSecret, string xRequestedWith);
        ...
        System.Threading.Tasks.Task<ApiResponse<Template>> GetShowTemplateAsyncWithHttpInfo (Body5 body, string xApiSecret, string xRequestedWith);
        ...
        public partial class TemplatesApi : ITemplatesApi
    {
        ...
        /// <returns></returns>
        public TemplatesApi(InvoiceNinjaSDK.Configuration configuration = null)
        {
        ...
        /// <summary>
        /// Returns a entity template with the template variables replaced with the Entities Returns a entity template with the template variables replaced with the Entities
        /// </summary>
        /// <exception cref="InvoiceNinjaSDK.ApiException">Thrown when fails to make API call</exception>
        /// <param name="body">The template subject and body</param>
        /// <param name="xApiSecret">The API secret as defined by the .env variable API_SECRET</param>
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns>Template</returns>
        public Template GetShowTemplate (Body5 body, string xApiSecret, string xRequestedWith)
        {
             ApiResponse<Template> localVarResponse = GetShowTemplateWithHttpInfo(body, xApiSecret, xRequestedWith);
        ...
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns>ApiResponse of Template</returns>
        public ApiResponse< Template > GetShowTemplateWithHttpInfo (Body5 body, string xApiSecret, string xRequestedWith)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling TemplatesApi->GetShowTemplate");
            // verify the required parameter 'xApiSecret' is set
            if (xApiSecret == null)
                throw new ApiException(400, "Missing required parameter 'xApiSecret' when calling TemplatesApi->GetShowTemplate");
            // verify the required parameter 'xRequestedWith' is set
            if (xRequestedWith == null)
                throw new ApiException(400, "Missing required parameter 'xRequestedWith' when calling TemplatesApi->GetShowTemplate");

            var localVarPath = "/api/v1/templates";
            ...
            {
                Exception exception = ExceptionFactory("GetShowTemplate", localVarResponse);
        ...
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns>Task of Template</returns>
        public async System.Threading.Tasks.Task<Template> GetShowTemplateAsync (Body5 body, string xApiSecret, string xRequestedWith)
        {
             ApiResponse<Template> localVarResponse = await GetShowTemplateAsyncWithHttpInfo(body, xApiSecret, xRequestedWith);
             return localVarResponse.Data;
        ...
        /// <param name="xRequestedWith">Used to send the XMLHttpRequest header</param>
        /// <returns>Task of ApiResponse (Template)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Template>> GetShowTemplateAsyncWithHttpInfo (Body5 body, string xApiSecret, string xRequestedWith)
        {
            // verify the required parameter 'body' is set
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling TemplatesApi->GetShowTemplate");
